...
public class ModerationServiceImpl implements ModerationService {
    ...
    public ModerationServiceImpl(IncidentModerationRepository incidentModerationRepository, IncidentStatusHistoryRepository incidentStatusHistoryRepository, ModelMapper modelMapper, WebClient.Builder webClientBuilder) {
        this.incidentModerationRepository = incidentModerationRepository;
        this.incidentStatusHistoryRepository = incidentStatusHistoryRepository;
        this.modelMapper = modelMapper;
        //this.rabbitMQProducer = rabbitMQProducer;
    ...
    public List<IncidentModeration> getAllIncidents() {
        List<IncidentModerationEntity> entities = incidentModerationRepository.findAll();
        return entities.stream()
                .map(entity -> new IncidentModeration(
                        entity.getIncidentId(),
                        entity.getStatus(),
                        entity.getStatusChangeTime(),
