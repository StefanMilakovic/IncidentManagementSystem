...
/*
**Konfiguracija RabbitMQ** poruka između servisa

### **ŠTA RADI:**
Podešava:
- **Exchange** (razmjenjivač poruka)
- **Queue** (red čekanja za poruke)
- **Binding** (povezivanje exchange-a sa queue-om)
```
incident-service → Exchange → Queue → moderation-service
*
 */
